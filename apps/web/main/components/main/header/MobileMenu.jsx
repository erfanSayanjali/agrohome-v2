...
const NAV_ITEMS = [
  ...
  { href: '/blogs', label: 'وبلاگ', icon: FaBlog },
  { href: '/about', label: 'درباره ما', icon: FaInfoCircle },
  { href: '/contact', label: 'تماس با ما', icon: HiOutlineMail },
];
...
const MobileMenu = ({ product_category = [], logoUrl }) => {
                ...
                <ul className="flex flex-col gap-1.5">
                    ...
                    >
                      <span
                        className={`flex h-9 w-9 items-center justify-center rounded-xl ${
                          isActive('/') ? 'bg-white/15' : 'bg-[#DDF4EA] text-[#105238]'
                        }`}
                      >
                        <FaHome size={15} />
                      </span>
                  ...
                  <li>
                    <button
                      ...
                      className={`w-full flex items-center gap-3 rounded-2xl px-3.5 py-3 text-sm font-medium transition-all ${
                    ...
                    >
                      ...
                      <span className="flex-1 text-right">کودهای خانگی</span>
                      <IoIosArrowDown
